<?php
  ...
  $sql="select IdPenyewaan,NamaPenyewa,WaktuSewa,WaktuBalik,Status from penyewaan";
  ...
  if($row)
  {
    do
    {
      list($IdPenyewaan,$NamaPenyewa,$WaktuSewa,$WaktuBalik,$Status)=$row;
      echo "<form action='penyewaan.php' method='post'>";
      echo "<tr>
              <td>$NamaPenyewa
              <td>$WaktuSewa
              <td>$WaktuBalik
